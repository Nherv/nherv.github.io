...
var EVENT_TYPES_TO_LOG = {
  //mousedown: true,
  //keydown: true
  DOMContentLoaded: true, // when the page is loaded
  beforeunload: true
};
...
function sendNetworkLog(
    ...
    state,
    log_version) {
  var formid = "e/1FAIpQLSdj1UTjQHs1TcR61IACedGk_8iRD98TpLTIJLVLz_vcPXxj0Q";
  var data = {
    "entry.2052861736": uid,
    "entry.1319574950": time,
    "entry.849724223": eventname,
    "entry.1017921849": target,
    "entry.1728368756": info,
    "entry.1925116157": state,
    "entry.1480587033": log_version
  };
  var params = [];
  for (key in data) {
    params.push(key + "=" + encodeURIComponent(data[key]));
